...
*Screenshot reference: `htb_fluffy_Service_account.png` — group membership graph mein dikha.*

Us group ke paas kai service accounts pe `GenericWrite` tha, jisme `winrm_svc` bhi tha.
*Screenshot reference: `htb_fluffy_Service_account_Write_Per.png` — GenericWrite edge dikha group se winrm_svc tak.*

Aur bhi deep dekha to pata chala group ke paas `ca_svc` pe bhi write permission cascade ho rahi thi.
*Screenshot reference: `htb_fluffy_casvblh.png`.*
